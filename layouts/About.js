...
import about from "@/public/akash.jpg";
      ...
      <div className="grid gap-6 lg:gap-0 place-items-center lg:grid-cols-[1fr,1.6fr] xl:mr-16 mx-6 lg:mx-0">
        ...
        <div>
          <p className="text-4xl font-bold mb-4">
            My name is Akash Anand. I’m a final year engineering undergrad. 👨🏻‍🎓
          </p>
          ...
          <p className="text-[#767676] text-xl mb-4">
            ...
            learnt C, then C++ and then finally when I started
          ...
          <ul className="flex flex-wrap gap-4 text-xl">
            <li>
              <Link
                href="mailto:anandakash656@gmail.com"
                target="_blank"
